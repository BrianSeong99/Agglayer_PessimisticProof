...
use risc0_pessimistic_proof::global_index::GlobalIndex;
pub use risc0_pessimistic_proof::keccak::digest::Digest;
use risc0_pessimistic_proof::keccak::keccak256_combine;
use risc0_pessimistic_proof::local_balance_tree::{LocalBalanceTree, LOCAL_BALANCE_TREE_DEPTH};
use risc0_pessimistic_proof::local_exit_tree::hasher::Keccak256Hasher;
use risc0_pessimistic_proof::local_exit_tree::{LocalExitTree, LocalExitTreeError};
use risc0_pessimistic_proof::local_state::StateCommitment;
use risc0_pessimistic_proof::multi_batch_header::signature_commitment;
use risc0_pessimistic_proof::nullifier_tree::{NullifierTree, NULLIFIER_TREE_DEPTH};
use risc0_pessimistic_proof::utils::smt::{Smt, SmtError};
use risc0_pessimistic_proof::utils::{FromBool as _, Hashable as _};
use risc0_pessimistic_proof::LocalNetworkState;
use risc0_pessimistic_proof::{
...
pub use risc0_agglayer_primitives as primitives;
// Re-export common primitives again as agglayer-types root types
pub use risc0_agglayer_primitives::{Address, Signature, SignatureError, B256, U256, U512};
pub use risc0_pessimistic_proof::bridge_exit::NetworkId;
...
pub enum Error {
    ...
    BalanceProofGenerationFailed {
        source: risc0_pessimistic_proof::utils::smt::SmtError,
        token: TokenInfo,
    },
...
pub fn compute_signature_info(
    ...
    let combined_hash = risc0_pessimistic_proof::multi_batch_header::signature_commitment(
        new_local_exit_root,
...
impl From<LocalNetworkStateData> for risc0_pessimistic_proof::NetworkState {
    fn from(state: LocalNetworkStateData) -> Self {
