...
use risc0_agglayer_primitives::{address, U256};
use risc0_agglayer_types::{Certificate, NetworkId};
use hex_literal::hex;
use risc0_pessimistic_proof::bridge_exit::BridgeExit;
use risc0_pessimistic_proof::bridge_exit::TokenInfo;
use risc0_pessimistic_proof::local_balance_tree::LocalBalanceTree;
use risc0_pessimistic_proof::local_exit_tree;
use risc0_pessimistic_proof::local_state::LocalNetworkState;
use risc0_pessimistic_proof::nullifier_tree::NullifierTree;
...
type TreeHasher = risc0_pessimistic_proof::local_exit_tree::hasher::Keccak256Hasher;
