pub use risc0_pessimistic_proof_core::imported_bridge_exit::{
...
impl From<ImportedBridgeExit> for risc0_pessimistic_proof_core::imported_bridge_exit::ImportedBridgeExit {
