...
pub use risc0_pessimistic_proof_core::local_balance_tree::{LocalBalancePath, LOCAL_BALANCE_TREE_DEPTH};
...
impl From<LocalBalanceTree<Keccak256Hasher>>
    for risc0_pessimistic_proof_core::local_balance_tree::LocalBalanceTree<Keccak256Hasher>
{
