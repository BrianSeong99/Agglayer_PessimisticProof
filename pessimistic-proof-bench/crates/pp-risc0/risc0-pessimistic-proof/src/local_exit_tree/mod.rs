use risc0_pessimistic_proof_core::local_exit_tree::hasher::Hasher;
...
pub use risc0_pessimistic_proof_core::local_exit_tree::hasher;
pub use risc0_pessimistic_proof_core::local_exit_tree::LocalExitTreeError;
...
{
    inner: risc0_pessimistic_proof_core::local_exit_tree::LocalExitTree<H, TREE_DEPTH>,
}
    ...
    H::Digest: std::fmt::Debug + Copy + Default + Serialize + for<'a> Deserialize<'a>,
{
    ...
    pub fn new() -> Self {
        Self {
            inner: risc0_pessimistic_proof_core::local_exit_tree::LocalExitTree {
                leaf_count: 0,
...
impl<H, const TREE_DEPTH: usize> From<LocalExitTree<H, TREE_DEPTH>>
    for risc0_pessimistic_proof_core::local_exit_tree::LocalExitTree<H, TREE_DEPTH>
where
    H: Hasher,
    H::Digest: std::fmt::Debug + Copy + Default + Serialize + for<'a> Deserialize<'a>,
{
