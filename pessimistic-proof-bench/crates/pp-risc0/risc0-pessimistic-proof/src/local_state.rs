use risc0_pessimistic_proof_core::{keccak::digest::Digest, local_exit_tree::hasher::Keccak256Hasher};
...
impl From<LocalNetworkState> for risc0_pessimistic_proof_core::NetworkState {
    fn from(state: LocalNetworkState) -> Self {
        risc0_pessimistic_proof_core::NetworkState {
...
impl From<StateCommitment> for risc0_pessimistic_proof_core::local_state::StateCommitment {
