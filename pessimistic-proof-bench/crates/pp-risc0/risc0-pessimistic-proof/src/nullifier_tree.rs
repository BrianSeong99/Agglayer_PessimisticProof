use risc0_pessimistic_proof_core::local_exit_tree::hasher::{Hasher, Keccak256Hasher};
pub use risc0_pessimistic_proof_core::nullifier_tree::NullifierKey;
pub use risc0_pessimistic_proof_core::nullifier_tree::NullifierPath;
pub use risc0_pessimistic_proof_core::nullifier_tree::NULLIFIER_TREE_DEPTH;
use risc0_pessimistic_proof_core::utils::FromBool;
...
impl From<NullifierTree<Keccak256Hasher>>
    for risc0_pessimistic_proof_core::nullifier_tree::NullifierTree<Keccak256Hasher>
{
